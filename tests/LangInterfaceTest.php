 ...
 *
 * @since 0.7.0 Migrate LangInterface tests to Brain Monkey.
 */
class LangInterfaceTest extends TestCase {
	 ...
	 * Tear down tests.
	 *
	 * @since 0.7.0 Tear down Brain Monkey after tests.
	 *
	 * @return void
	 */
	 ...
	 *
	 * @since 0.7.0 Use shared options for expanded language tests.
	 *
	 * @return array
	 */
	 ...
	 *
	 * @since 0.7.0 Set up Brain Monkey hooks for options loading.
	 *
	 * @param array  $options
	 ...
	 * Test get_languages.
	 *
	 * @since 0.7.0 Migrate hidden language filter assertions to Brain Monkey.
	 *
	 ...
	 *
	 * @since 0.7.0 Migrate allowed language assertions to Brain Monkey.
	 *
	 ...
	 *
	 * @since 0.7.0 Migrate default language assertions to Brain Monkey.
	 *
	 ...
	 *
	 * @since 0.7.0 Migrate current language mutation assertions to Brain Monkey.
	 *
	 ...
	 *
	 * @since 0.7.0 Migrate translatable post type assertions to Brain Monkey.
	 *
	 ...
	 *
	 * @since 0.7.0 Migrate post type translatability assertions to Brain Monkey.
	 *
	 ...
	 *
	 * @since 0.7.0 Migrate translatable taxonomy assertions to Brain Monkey.
	 *
	 ...
	 *
	 * @since 0.7.0 Migrate taxonomy translatability assertions to Brain Monkey.
	 *
